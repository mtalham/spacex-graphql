...
export type PastLaunchesQueryVariables = {
  limit: Scalars['Int'];
};
...
export const PastLaunchesDocument = gql`
  ...
  export class PastLaunchesGQL extends Apollo.Query<PastLaunchesQuery, PastLaunchesQueryVariables> {
    document = PastLaunchesDocument;
